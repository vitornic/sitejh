...
if (isset($_POST['Cadastrar'])) { // Ao clicar no botão cadastrar
    ...
    include '../data/adminData.inc';

    if ($Email == $email) {
        header("refresh: 5;../administrativo.php");
        ...
        header("refresh: 5;../administrativo.php#paralogin");
    ...
    if (mysqli_num_rows($log_verifica) <= 0) {
        ...
        setcookie("EmailADM", $_SESSION['log_email'], time()+60*60*24, '/');
        setcookie("NomeADM", $log_nome, time()+60*60*24, '/');
